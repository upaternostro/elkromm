 ...
 *  <tr><td>0x00-0x31</td><td>?</td><td>Not mapped by any DTO field</td></tr>
 *  <tr><td>0x32</td><td>Tampering</td><td>{@link Event#C2PE_TAMPERING}; the serializer also writes the same value at {@code 0x40} and {@code 0x5b} (mirrors, not distinct events)</td></tr>
 *  <tr><td>0x33</td><td>?</td></tr>
 ...
 *  <tr><td>0x36-0x37</td><td>?</td></tr>
 *  <tr><td>0x38</td><td>Burglary alarm</td><td>{@link Event#C2PE_BURGLAR_ALARM}; also mirrored at {@code 0x39}, {@code 0x3a}, {@code 0x3b}</td></tr>
 *  <tr><td>0x39-0x3b</td><td>(mirror of 0x38)</td></tr>
 *  <tr><td>0x3c</td><td>Pre-alarm</td><td>{@link Event#C2PE_PRE_ALARM}</td></tr>
 *  <tr><td>0x3d-0x3f</td><td>?</td></tr>
 *  <tr><td>0x40</td><td>(mirror of 0x32, tampering)</td></tr>
 ...
 *  <tr><td>0x44-0x46</td><td>?</td></tr>
 *  <tr><td>0x47</td><td>Medical emergency</td><td>{@link Event#C2PE_MEDICAL_EMERGENCY}</td></tr>
 *  <tr><td>0x48</td><td>System fault</td><td>{@link Event#C2PE_SYSTEM_FAULT}; also mirrored at {@code 0x4b}</td></tr>
 *  <tr><td>0x49</td><td>?</td></tr>
 *  <tr><td>0x4a</td><td>Partition arm/disarm</td><td>{@link Event#C2PE_PARTITIONS_ON_OFF}</td></tr>
 *  <tr><td>0x4b</td><td>(mirror of 0x48, system fault)</td></tr>
 *  <tr><td>0x4c</td><td>System arm/disarm</td><td>{@link Event#C2PE_SYSTEM_ON_OFF}; also mirrored at {@code 0x4d}, {@code 0x4f}</td></tr>
 *  <tr><td>0x4d</td><td>(mirror of 0x4c)</td></tr>
 *  <tr><td>0x4e</td><td>Hold-up</td><td>{@link Event#C2PE_HOLD_UP}</td></tr>
 *  <tr><td>0x4f</td><td>(mirror of 0x4c)</td></tr>
 ...
 *  <tr><td>0x5b</td><td>(mirror of 0x32, tampering)</td></tr>
 *  <tr><td>0x5c-0x63</td><td>?</td></tr>
 *  <tr><td>0x64-0xa3</td><td>Input codes</td><td>64 bytes, one per logical input ({@link ElkrommFacade#MAX_LOGICAL_INPUTS}), {@code 0xff} if the input doesn't exist</td></tr>
 *  <tr><td>0xa4-0xa7</td><td>Block checksum</td></tr>
 * </table>
 * <p>
...
public class C200bParameters implements ElkrommSerializer<org.paternostro.elkromm.dto.C200bParameters> 
{
    ...
    public byte[] serialize(org.paternostro.elkromm.dto.C200bParameters obj) {
        ...
        System.arraycopy(obj.getInputCodes(), 0, data, SerializersConstants.C200B_INPUT_CODES_OFFSET, ElkrommFacade.MAX_LOGICAL_INPUTS);
    ...
    public org.paternostro.elkromm.dto.C200bParameters deserialize(byte[] data) {
        ...
        for (int i = 0; i < ElkrommFacade.MAX_LOGICAL_INPUTS; i++) {
            retval.setInputCode(i, data[i + SerializersConstants.C200B_INPUT_CODES_OFFSET]);
        }
