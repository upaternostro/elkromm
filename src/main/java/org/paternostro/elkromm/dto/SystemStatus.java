...
/**
 * Which partitions are currently armed.
 * <p>
...
public class SystemStatus implements Serializable
{
     ...
     *
     * @param activePartitions per-partition armed flags, length {@link ElkrommFacade#MAX_PARTITIONS}
     */
    ...
    /**
     * Returns a copy of the per-partition armed flags.
     *
     * @return the armed flags, length {@link ElkrommFacade#MAX_PARTITIONS}
     */
    ...
    /**
     * Sets the per-partition armed flags.
     *
     * @param activePartitions the flags to set, not {@code null}
     * @throws IllegalArgumentException if {@code activePartitions} is {@code null}
     */
    ...
    /**
     * Sets the armed flag of a single partition.
     *
     * @param partition the partition to set
     * @param arming {@code true} if armed
     */
