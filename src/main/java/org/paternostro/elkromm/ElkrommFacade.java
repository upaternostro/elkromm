...
public interface ElkrommFacade
{
    ...
    /** Number of expansion units supported by the panel. Warning: first expansion (#0) is embedded in the panel, this is the number of expansions that can be added */
