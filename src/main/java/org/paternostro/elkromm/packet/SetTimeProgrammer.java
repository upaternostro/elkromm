...
public class SetTimeProgrammer extends ElkrommPacket {
    public SetTimeProgrammer(int plantCode12, int plantCode34, int totalPackets, int index, int dataLength, byte[] data) {
        ...
        assert dataLength == (3 * ElkrommFacade.NUM_COMMANDS * SerializersConstants.COMMAND_LENGTH + 7 + 4) && data != null && data.length == dataLength : "SetTimeProgrammer: data: mismatch in data length";
    }
}
