...
public class TimeProgrammerTest {
    ...
    public void test()
    {
        ...
        for (int i = 0; i < workingDayCommands.length; i++) {
            workingDayCommands[i] = new Command(i % 2 == 0 ? Action.CA_ENABLE : Action.CA_DISABLE, (byte)(i + 1), i % 2 == 0 ? ObjectType.COT_PARTITIONS : ObjectType.COT_USER, (byte)(23 - i), (byte)(59 - i));
        }

        for (int i = 0; i < preHolidayDayCommands.length; i++) {
            preHolidayDayCommands[i] = new Command(i % 2 == 0 ? Action.CA_DISABLE : Action.CA_ENABLE, (byte)(i + 1), i % 2 == 0 ? ObjectType.COT_USER : ObjectType.COT_PARTITIONS, (byte)i, (byte)i);
        }

        for (int i = 0; i < holidayDayCommands.length; i++) {
            holidayDayCommands[i] = new Command(i % 2 == 0 ? Action.CA_ENABLE : Action.CA_DISABLE, (byte)(i + 1), i % 2 == 0 ? ObjectType.COT_PARTITIONS : ObjectType.COT_USER, (byte)(23 - i), (byte)(59 - i));
        }
